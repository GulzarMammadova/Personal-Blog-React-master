...
export function About() {
  return (
    ...
    <img className='about-img' src={aboutImg} alt='pic'></img>
      <h1>I’m Amirhossein Meydani
A <span>Backend</span> and <span>Android</span> Programmer and <span>UI/UX </span>Designer</h1>
    </div>
